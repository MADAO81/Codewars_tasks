# You are required to implement a function that returns the index of the nth occurrence of a substring within a string 
# (considering that those substring could overlap each other). If there are less than n occurrences of the substring, return -1.
