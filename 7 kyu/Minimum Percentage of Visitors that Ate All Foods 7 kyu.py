...
# Task
# You are the manager of an amusement park! Today you are doing research on the revenue 
# from various food items sold throughout your venue. 
# All the vendors working for you can report the percentage of visitors that eat 
# that particular food that they sell. Based on this data, your current goal is to 
# create a method to figure out the minimum percentage of all visitors that must 
...
# If the park had two items (Hot Dogs and Cotton Candy) and 50% of the visitors ate a 
# hot dog and 50% of the visitors had some cotton candy, it would be easy to say that 
# the maximum percentage of visitors that ate both items would be 50%. But you are trying 
# to find the minimum percentage, and it turns out that would actually be 0% of visitors
# that ate both items, which is maybe not so obvious.
