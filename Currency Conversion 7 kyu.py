...
# Given an integer (usd) representing the amount of dollars you have and a string (currency) representing the name of the currency used in 
# another country, it is your task to determine the amount of foreign currency you will receive when you exchange your United States Dollars.
# However, there is one minor issue to deal with first. The screens and monitors at the Exchange are messed up. 
# Some conversion rates are correctly presented, but other conversion rates are incorrectly presented. For some countries, 
# they are temporarily displaying the standard conversion rate in the form of a number's binary representation!
...
# Instead, the display is showing 1 USD converts to 10101 Czech Koruna. You take it upon yourself to sort this out. 
