...
# (choose one or more) which contains form fields so visitors can send emails 
# or leave a comment on your website with ease. However, with ease comes danger. 
# Every now and then, a hacker visits your website and attempts to compromise 
# it through the use of XSS (Cross Site Scripting). 
# This is done by injecting script tags into the website through form 
...
def html_special_chars(data): 
    swap = {"<":"&lt;", ">":"&gt;", '"':"&quot;", "&":"&amp;"}
    return data.translate(data.maketrans(swap))
