...
# is needed if you have a clothes amount of clothes. The function will accept 3 arguments: - water, 
# load (or max_loadin Ruby) and clothes.
...
# return 'Too much clothes'. The washing machine also cannot handle any amount of clothes
# less than load (max_load). If that is the case, return 'Not enough clothes'.
