...
# that the savings over the normal high street price would effectively cover the cost of your holiday.
...
def duty_free(price, discount, holiday_cost):
    save_money = price/(100/discount)
    return math.floor(holiday_cost/save_money)
