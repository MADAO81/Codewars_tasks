...
def greet(language):
    greet = { "english":"Welcome", "czech":"Vitejte", "danish": "Velkomst", "dutch": "Welkom"
             ...
             ,"latvian": "Gaidits", "lithuanian": "Laukiamas", "polish":"Witamy", "spanish":"Bienvenido"
             ,"swedish":"Valkommen", "welsh":"Croeso"}
    return greet.get(language,"Welcome")
