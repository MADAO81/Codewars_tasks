...
def calculate_age(year_of_birth, current_year):
    ...
    if result < -1:
        return f"You will be born in {abs(result)} years."
    elif result == -1:
        return f"You will be born in {abs(result)} year."
    elif result == 0:
        return 'You were born this very year!'
    elif result == 1:
        return f"You are {result} year old."
    else:
        return f"You are {result} years old."
